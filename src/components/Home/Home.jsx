    ...
    return (
        <>
            <section className={`flex flex-col relative mb-10 `}>
                ...
                {/* CONTENT */}
                <div className='w-auto px-4 py-5 h-auto md:absolute md:left-0 md:flex flex-col items-center lg:absolute lg:bottom-8 lg:ml-14 xl:bottom-16 xl:ml-20 2xl:ml-24 2xl:bottom-40'>
